...
$doc->addStyleSheet('apps/'.$this->application.'/themes/system/css/system.css');
$doc->addStyleSheet('apps/'.$this->application.'/themes/'.$this->template.'/css/template.css');

if ($this->direction == 'rtl') {
	$doc->addStyleSheet('apps/'.$this->application.'/themes/'.$this->template.'/css/template_rtl.css');
}
...
if ($this->params->get('textBig')) {
	$doc->addStyleSheet('apps/'.$this->application.'/themes/'.$this->template.'/css/textbig.css');
}

if ($this->params->get('highContrast')) {
	$doc->addStyleSheet('apps/'.$this->application.'/themes/'.$this->template.'/css/highcontrast.css');
}
?>
...
<!--[if IE 7]>
<link href="apps/<?php echo $this->application; ?>/themes/<?php echo  $this->template ?>/css/ie7.css" rel="stylesheet" type="text/css" />
<![endif]-->

<!--[if gte IE 8]>
<link href="apps/<?php echo $this->application; ?>/themes/<?php echo  $this->template ?>/css/ie8.css" rel="stylesheet" type="text/css" />
<![endif]-->
</head>
